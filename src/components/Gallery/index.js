            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="card work col">
                        <a target="_blank" href="https://gljacobs.github.io/project1/"><img src={camp} alt="Camp Dad" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://limitless-reaches-94201.herokuapp.com/"><img src={gbooks} alt="GBooks-Search" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://chitchatv1.herokuapp.com/"><img src={ccv1} alt="ChitChatv1" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://morning-scrubland-86999.herokuapp.com/"><img src={ezchat} alt="EZ Chat" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://ezlogin.herokuapp.com"><img src={login} alt="EZ Login" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://gljacobs.github.io/secret-santa/"><img src={santa} alt="Secret Santa" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://gljacobs.github.io/clicky-game/"><img src={clicky} alt="Clicky-Game" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://gljacobs.github.io/dragon-egg-game/"><img src={drg} alt="Dragon Egg Game" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://evening-lowlands-50463.herokuapp.com/"><img src={friend} alt="Friend Finder" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://github.com/gljacobs/Word-Guess"><img src={hangman} alt="Letter Guess" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://github.com/gljacobs/project2"><img src={gymate} alt="Gymate" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://gljacobs.github.io/GifTastic/"><img src={gif} alt="GifTastic" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://damp-lowlands-77901.herokuapp.com/"><img src={burger} alt="Burger" /></a>
                        <h5><a target="_blank" href="https://damp-lowlands-77901.herokuapp.com/">Eat The Burger</a>
                            <a className="gitlink" href="https://github.com/gljacobs/burger" target="_blank"><i className="fab fa-github-square" /></a>
                        </h5>
                    </div>
                    <div className="card work col">
                        <a target="_blank" href="https://gljacobs.github.io/Psychic-Game/"><img src={word} alt="Guessing Game" /></a>
                    ...
                    <div className="card work col">
                        <a target="_blank" href="https://gljacobs.github.io/todolist/"><img src={todo} alt="React ToDo" /></a>
